...
public class CherryFrameApplication extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        primaryStage.setTitle("CherryPick Management Studio");
        primaryStage.setScene(scene);
        primaryStage.show();
    }

    public static void changeScene(final String fxmlName) throws IOException {
        final Parent pane = FXMLLoader.load(Objects.requireNonNull(CherryFrameApplication.class.getResource(fxmlName)));
